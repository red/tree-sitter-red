...
"Emoji 😀🆒"
"^(1F3F4)^(200D)^(2620)xx"
"xx^(1F3F4)^(200D)^(2620)xx"
while [ true ][99.3 32 + 2 / 4 100]
1.#nan
1.#inf
"fjdklsfjkl"
#"a"
...
0:45.0
2:22
udp-port/awake: func [event [event!] /local port] [
...
(1e30,0)
equal? "blahblah2" append "blah" "blah^2"
...
ctx1/ctx2/3/foo: func [a][
    a * 2 + 1 / 100h
]
--assert type+id? throw return do [try [exit]]
%cache/
...
fd00:1234:abcd:0000:0000:0000:0000:0005
2001:db8:0:0:0:0:0:1
fe80:0:0:0:202:b3ff:fe1e:8329
fd00:1234:abcd:0:0:0:0:5
2001:db8::1
...
%abc
#include %jfkd0
https://[2001:db8::192.0.2.33]
https://[2001:db8::192.0.2.33]:32
https://[2001:db8::192.0.2.33]:32/%abc/jk
